# -*- coding: utf-8 -*-
"""
Created on Mon Oct 23 00:39:27 2023
...
from SubtractDominantMotion_InverseCompositionAffine import SubtractDominantMotion_InverseCompositionAffine 
import cv2
...
for i in range(1, seq.shape[2]):
    ...
    mask = SubtractDominantMotion_InverseCompositionAffine(temp, image, threshold, num_iters, tolerance)
    ...
    if i in [30, 60, 90, 120]:
        cv2.imwrite(f"../data/results/AntSequence_InverseCompositionAffine{i}.jpg", img * 255)
