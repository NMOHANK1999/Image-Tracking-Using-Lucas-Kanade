...
parser.add_argument('--threshold', type=float, default=1e4, help='dp threshold of Lucas-Kanade for terminating optimization')
...
for i in range(1, seq.shape[2]):
    ...
    if i in [30, 60, 90, 120]:
        cv2.imwrite(f"../data/results/AntSequence_{i}.jpg", img * 255)
